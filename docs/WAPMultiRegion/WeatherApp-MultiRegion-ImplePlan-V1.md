...
`https://d-zf3io5p23g.execute-api.us-east-1.amazonaws.com/health` directly
...
green:
- `https://876mh0k6q1.execute-api.us-east-1.amazonaws.com/health` → 200, `us-east-1`
- `https://ag7upj7vr0.execute-api.us-west-2.amazonaws.com/health` → 200, `us-west-2`
...
1. **CloudFront never sees API traffic today — there is no Origin Group to add.**
   ...
   `API_BASE_URL: 'https://876mh0k6q1.execute-api.us-east-1.amazonaws.com'` — the
...
```bash
curl -s https://876mh0k6q1.execute-api.us-east-1.amazonaws.com/health | jq .
...
curl -s "$WEST_API" | jq .
curl -s "https://876mh0k6q1.execute-api.us-east-1.amazonaws.com/weather?city=London" | jq '.city'
```
...
```diff
-  API_BASE_URL: 'https://876mh0k6q1.execute-api.us-east-1.amazonaws.com',
...
```bash
curl -s "https://876mh0k6q1.execute-api.us-east-1.amazonaws.com/weather?city=ReplicationTestCity"
sleep 3
